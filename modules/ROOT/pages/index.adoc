...
. https://redhatquickcourses.github.io/rhde-bootc-provision/[Provisioning Red Hat Device Edge Systems with Image Mode for RHEL]

. https://redhatquickcourses.github.io/rhde-bootc-update/[Updating and Repurposing Red Hat Device Edge Systems with Image Mode for RHEL]

IMPORTANT: Red Hat associates must enroll using the https://training-lms.redhat.com/sso/saml/auth/rhlpint?RelayState=deeplinkoffering%3D84937026[Red Hat Learning Portal], and Red Hat Partners must enroll using the https://training-lms.redhat.com/sso/saml/auth/rhopen?RelayState=deeplinkoffering%3D84937349[Red Hat Partner Connect].
...
* https://training-lms.redhat.com/sso/saml/auth/rhlpint?RelayState=deeplinkoffering=84932767[HOL019 for Red Hat associates^] on Red Hat Learning Portal

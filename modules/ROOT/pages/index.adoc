...
IMPORTANT: Red Hat employees must enroll using its https://training-lms.redhat.com/sso/saml/auth/rhlpint?RelayState=deeplinkoffering%3D84937026[Red Hat Univerisity] entry, and Red Hat Partners must enroll using its https://training-lms.redhat.com/sso/saml/auth/rhopen?RelayState=deeplinkoffering%3D84937349[Red Hat Partner Connect] entry.
...
* Test and validate system images for edge devices using local VMs.

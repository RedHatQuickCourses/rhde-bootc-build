...
7. Clean your test environment before moving to the final chapter.
...
.. If you wish, you can also remove your temporary directories, especially the large OCI directory which now contains hunders of MB of bootc container image layers.
+
[source,subs="verbatim,quotes"]
--
$ *cd*

...
6. If you wish, you can now delete your test VM and temporary directories, especially the large OCI directory which now contains hunders of MB of bootc container image layers.
+
[source,subs="verbatim,quotes"]
--
$ *virsh destroy bootc-test*

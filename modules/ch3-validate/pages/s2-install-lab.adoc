...
6. Create another test VM, this time from the `webapp-bootc` container image.

.. Return to your home directory and copy a second local container image to your OCI directory.
+
[source,subs="verbatim,quotes"]
--
$ *cd*

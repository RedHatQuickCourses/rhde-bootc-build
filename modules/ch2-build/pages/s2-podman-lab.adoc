...
You will build a containerfile to produce a bootc container image which includes a single-page web application, and test that container image as a regular application container. You will also compare the bootc container image for your application with a regular application image for the same application.
...
We will see, later in this course, how to test the bootc container image in a way that makes evident that kind of issue.
